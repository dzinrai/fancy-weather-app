...
const getLoc = (placeName,lang='en') => {
    return `https://api.opencagedata.com/geocode/v1/json?q=${placeName}&key=1a72d9365e6b4965a0ac1704fb67223c&language=${lang}&pretty=1`;
};
const getPlace = (lng, lat,lang='en') => {
    return `https://api.opencagedata.com/geocode/v1/json?q=${lat}+${lng}&key=1a72d9365e6b4965a0ac1704fb67223c&language=${lang}&pretty=1`;
};
const translateAPI = (str, initLang, targetLang) => {
    const pair = initLang ? `${initLang}-${targetLang}` : targetLang;
    return `https://translate.yandex.net/api/v1.5/tr.json/translate?key=trnsl.1.1.20200506T113704Z.64e070cb5c691f68.0ab213249c3470faf758481f9a2bc04d3782b82c&text=${str}&lang=${pair}`;
};
